...
function sumaPrecio (producto1,producto2,producto3) {
    return producto1 + producto2 + producto3;
}

const productos = [
    {nombre: "Cubo", precio: 5},
    {nombre: "Cascos Gamer", precio: 80 },
    {nombre: "lapiz", precio: 1.20 }
]

console.log(`Precio Cubo: ${productos[0].precio}`);
console.log(`Precio Cascos: ${productos[1].precio}`);
console.log(`Precio Lapiz: ${productos[2].precio}`);
console.log(`Precio total: ${sumaPrecio(productos[0].precio, productos[1].precio, productos[2].precio)}`);
